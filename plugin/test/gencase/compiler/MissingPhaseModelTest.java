...
public class MissingPhaseModelTest extends ParsingTestCase {

    private Module module;
    private PsiManagerEx psiManager;

    public MissingPhaseModelTest() {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        LightVirtualFile file1 = new LightVirtualFile("Phase1", this.myLanguage, loadFile("PhaseAnnotated.gcl"));
    ...
    public void testMissingPhaseModel() {
        ...
        try {
            ...
            TestCase.assertEquals("Model Model not defined", ex.getMessages().stream()
