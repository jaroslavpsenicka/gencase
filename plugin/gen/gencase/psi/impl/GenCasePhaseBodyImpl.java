...
public class GenCasePhaseBodyImpl extends ASTWrapperPsiElement implements GenCasePhaseBody {

  public GenCasePhaseBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GenCaseVisitor visitor) {
    visitor.visitPhaseBody(this);
  }
